...
if __name__ == '__main__':
    ...
    graph_sameas = rdf_translator.generate_sameas_relations(links_wikidata, rdf_translator.wikidata_uri, g)
    ...
    graph_sameas = rdf_translator.generate_sameas_relations(links_pico, rdf_translator.umls_uri, g)
    graph_sameas = rdf_translator.generate_sameas_relations(links_pico_bioportal, rdf_translator.umls_uri, g)
    ...
    graph_sameas = rdf_translator.generate_sameas_relations(links_dbpedia, rdf_translator.dbpedia_uri, g)
