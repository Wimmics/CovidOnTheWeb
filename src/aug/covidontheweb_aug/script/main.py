...
if __name__ == '__main__':
    ...
    graph_sameas = rdf_translator.generate_closematch_relations(links_pico, rdf_translator.wikidata_uri, g)
    ...
    graph_sameas = rdf_translator.generate_closematch_relations(links_dbpedia, rdf_translator.wikidata_uri, g)
