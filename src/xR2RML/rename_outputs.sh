...
# Articles metadata
mv output_cord19_json_light_authors.ttl          $DIR/cord19-nekg-metadata-authors.ttl
mv output_cord19_metadata_pmcid.ttl              $DIR/cord19-nekg-metadata-pmcid.ttl
mv output_cord19_metadata_sha.ttl                $DIR/cord19-nekg-metadata-sha.ttl
